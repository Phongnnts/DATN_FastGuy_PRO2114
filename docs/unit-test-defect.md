...
| --------- | ------------ | ----------- | ----- | ------------------ | ------------------ | ---------- | ---------- | ----------- | ---------------- | --------- | ----------- | -------------------- | ----- |
| BUG-UT-001 | ghnDistrictId không phải số gây HTTP 500 | Lập trình viên | Open | 2 | 3 | 2/2 lần | Đỗ Huy Hoàng | 26/07/2026 | 1. Gọi tạo địa chỉ với ghnDistrictId="abc" | ghnDistrictId=abc | Integer.parseInt không được bọc lỗi, phát sinh Exception → 500. Cần trả 400 với thông báo rõ | Chrome, FastGuy API v2 | UT023 |
