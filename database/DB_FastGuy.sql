...
INSERT INTO dbo.ShippingConfig(config_id,config_key,config_value) VALUES (1,'ghn_from_district_id','1442'),(2,'ghn_from_ward_code','20107'),(3,'service_fee','0'),(4,'low_stock_threshold','5'),(5,'morning_count_notice_enabled','1'),(6,'morning_count_notice_title',N'Cửa hàng đang chuẩn bị nguyên liệu'),(7,'morning_count_notice_message',N'Chúng tôi đang kiểm kê đầu ngày. Bạn vẫn có thể xem thực đơn và đặt món theo giờ hoạt động.'),(8,'morning_count_notice_image_url',''),(9,'morning_count_notice_link',''),(10,'morning_count_notice_cta_label',N'Xem thông báo');
