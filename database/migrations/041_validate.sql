...
BEGIN TRY
    ...
    IF @reasonDefinition NOT LIKE N'%DELIVERY_FAILURE_CODEISNULL%' OR @reasonDefinition NOT LIKE N'%DELIVERY_FAILURE_CODEIN(''CUSTOMER_UNREACHABLE'',''INVALID_ADDRESS'',''CUSTOMER_RESCHEDULED'',''CUSTOMER_REJECTED'',''SHIPPER_INCIDENT'',''PRODUCT_INCIDENT'')%' THROW 51505, 'Delivery failure code constraint definition invalid.', 1;
