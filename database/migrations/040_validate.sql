...
BEGIN TRY
    BEGIN TRANSACTION;
    IF (SELECT COUNT(*) FROM dbo.SchemaMigrationHistory WHERE migration_id IN ('000_preflight_history','010_expand_schema','020_backfill_legacy','030_constraints_indexes','035_backend_hardening','039_inventory_waste_state')) <> 6 THROW 51400, 'Migration history incomplete.', 1;
