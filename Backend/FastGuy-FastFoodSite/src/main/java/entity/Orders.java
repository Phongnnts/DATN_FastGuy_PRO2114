...
public class Orders {
    ...
    void prePersist() {
        ...
        if (statusEnteredAt == null) statusEnteredAt = createdAt;
    ...
    public String getIdempotencyOwner() {
        return idempotencyOwner;
    }

    public void setIdempotencyOwner(String idempotencyOwner) {
    ...
    public BigDecimal getCodCollectedAmount() {
        return codCollectedAmount;
    }

    public void setCodCollectedAmount(BigDecimal codCollectedAmount) {
    ...
    public Integer getShippingServiceTypeId() {
        return shippingServiceTypeId;
    }

    public void setShippingServiceTypeId(Integer shippingServiceTypeId) {
    ...
    public String getGhnTrackingUrl() {
        return ghnTrackingUrl;
    }

    public void setGhnTrackingUrl(String ghnTrackingUrl) {
        this.ghnTrackingUrl = ghnTrackingUrl;
    }
    ...
    public String getGuestReturnProofHash() {
        return guestReturnProofHash;
    }

    public void setGuestReturnProofHash(String guestReturnProofHash) {
        this.guestReturnProofHash = guestReturnProofHash;
    }
    ...
    public WorkShift getStaffShift() {
        return staffShift;
    }

    public void setStaffShift(WorkShift staffShift) {
    ...
    public int getDeliveryAttemptLimit() {
        return deliveryAttemptLimit;
    }

    public void setDeliveryAttemptLimit(int deliveryAttemptLimit) {
        this.deliveryAttemptLimit = deliveryAttemptLimit;
    }

    public String getDeliveryFailureCode() {
        return deliveryFailureCode;
    }

    public void setDeliveryFailureCode(String deliveryFailureCode) {
        this.deliveryFailureCode = deliveryFailureCode;
    }

    public LocalDateTime getDeliveryFailedAt() {
        return deliveryFailedAt;
    }

    public void setDeliveryFailedAt(LocalDateTime deliveryFailedAt) {
        this.deliveryFailedAt = deliveryFailedAt;
    }

    public LocalDateTime getRetryScheduledAt() {
        return retryScheduledAt;
    }

    public void setRetryScheduledAt(LocalDateTime retryScheduledAt) {
        this.retryScheduledAt = retryScheduledAt;
    }

    public LocalDateTime getReturnedToStoreAt() {
        return returnedToStoreAt;
    }

    public void setReturnedToStoreAt(LocalDateTime returnedToStoreAt) {
        this.returnedToStoreAt = returnedToStoreAt;
    }
    ...
    public void setRefundProcessedBy(Integer refundProcessedBy) {
    ...
    public String getRefundProofPublicId() {
        return refundProofPublicId;
    }

    public void setRefundProofPublicId(String refundProofPublicId) {
        this.refundProofPublicId = refundProofPublicId;
    }

    public String getRefundProofContentType() {
        return refundProofContentType;
    }

    public void setRefundProofContentType(String refundProofContentType) {
        this.refundProofContentType = refundProofContentType;
    }

    public LocalDateTime getRefundProofUploadedAt() {
        return refundProofUploadedAt;
    }

    public void setRefundProofUploadedAt(LocalDateTime refundProofUploadedAt) {
        this.refundProofUploadedAt = refundProofUploadedAt;
    }
