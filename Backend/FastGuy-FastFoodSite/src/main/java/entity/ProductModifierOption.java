...
public class ProductModifierOption {
    ...
    public int getModifierOptionId() {
        return modifierOptionId;
    }

    public void setModifierOptionId(int modifierOptionId) {
        this.modifierOptionId = modifierOptionId;
    }

    public ProductModifierGroup getGroup() {
        return group;
    }

    public void setGroup(ProductModifierGroup group) {
        this.group = group;
    }
