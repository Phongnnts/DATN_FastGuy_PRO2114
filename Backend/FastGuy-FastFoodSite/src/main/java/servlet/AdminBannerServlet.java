...
public class AdminBannerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (path == null || path.equals("/")) {
            List<Map<String, Object>> list = bannerDAO
                .findAll()
                .stream()
                .map(this::toMap)
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (body.containsKey("sortOrder")) b.setSortOrder(
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            if (body.containsKey("imageUrl")) b.setImageUrl(
                (String) body.get("imageUrl")
            );
            if (body.containsKey("title")) b.setTitle(
                (String) body.get("title")
            );
            if (body.containsKey("subtitle")) b.setSubtitle(
            ...
            if (body.containsKey("isActive")) b.setIsActive(
