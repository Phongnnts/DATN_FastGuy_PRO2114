...
public class AdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } else if (path.equals("/reports/cancelled")) {
            var data = adminService.getDashboard();
            java.util.Map<String, Object> result = new java.util.HashMap<>();
            result.put("cancelledOrders", data.get("cancelledOrders"));
            result.put("refundedOrders", data.get("refundedOrders"));
            result.put("totalRefundAmount", data.get("totalRefundAmount"));
