...
final class UserAvatarPolicy {
    ...
    static String normalize(Object raw) {
        ...
        if (!(raw instanceof String value)) throw new IllegalArgumentException("URL ảnh đại diện không hợp lệ");
    ...
    static String validationError(String value) {
        ...
        if (!value.regionMatches(true, 0, "https://", 0, 8)) return "URL ảnh đại diện phải dùng HTTPS";
        return null;
    }
}
