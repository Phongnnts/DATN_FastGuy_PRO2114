...
test('product detail favorites, sizes, and narrow related cards expose premium states', () => {
  ...
  assert.match(productDetail, /availableVariants\.find\(\(variant\) => variant\.isDefault\)/);
  assert.doesNotMatch(productDetail, /product\.modifierGroups|selectedModifiers|modifierErrors/);
