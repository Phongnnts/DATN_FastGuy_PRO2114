...
.assignment-picker{position:relative}.assignment-picker summary{display:flex;min-height:44px;align-items:center;padding:8px;border:1px solid var(--admin-hairline);border-left:3px solid var(--admin-brand);border-radius:10px;background:#fff;cursor:pointer;font-size:11px;font-weight:700}.assignment-options{position:absolute;z-index:5;top:calc(100% + 4px);left:0;width:240px;max-height:300px;overflow:auto;padding:10px;border:1px solid var(--admin-hairline);border-radius:12px;background:#fff;box-shadow:0 12px 28px rgba(24,34,48,.16)}.assignment-options section+section{margin-top:10px;padding-top:10px;border-top:1px solid var(--admin-hairline)}.assignment-options strong,.assignment-options small{display:block;margin-bottom:4px;font-size:10px}.assignment-options label{display:flex;min-height:40px;align-items:center;gap:8px;font-size:11px}.assignment-options input{width:18px;height:18px}.assignment-chips{display:grid;gap:4px;margin-top:6px}.assignment-chip{display:flex;justify-content:space-between;gap:4px;padding:4px 6px;border-radius:6px;background:var(--admin-brand-soft);font-size:10px}.assignment-chip small{font-size:8px;color:var(--admin-muted)}
</style>
