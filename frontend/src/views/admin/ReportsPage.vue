...
const STATUS_COLORS = { PENDING: COLORS.yellow, CONFIRMED: COLORS.blue, PREPARING: COLORS.purple, READY: COLORS.cyan, ASSIGNED: COLORS.blue, PICKED_UP: COLORS.pink, DELIVERED: COLORS.green, CANCELLED: COLORS.red };
const STATUS_LABELS = { PENDING: 'Chờ xử lý', CONFIRMED: 'Đã xác nhận', PREPARING: 'Đang chế biến', READY: 'Sẵn sàng giao', ASSIGNED: 'Đã gán shipper', PICKED_UP: 'Đang giao', DELIVERED: 'Đã giao', CANCELLED: 'Đã hủy' };
