        ...
        <div class="container">
          <div class="about-grid">
            <div class="about-copy">
              <p class="about-kicker">Về FastGuy</p>
              <h2>FastGuy — Đặt món nhanh, giao tận nơi</h2>
              <p>FastGuy là nền tảng đặt đồ ăn nhanh giúp bạn chọn món yêu thích chỉ trong vài thao tác. Với thực đơn đa dạng từ burger, pizza, gà rán đến thức uống, chúng tôi cam kết giao hàng trong 30 phút để bạn thưởng thức món ngon đúng lúc.</p>
              <div class="about-highlights">
                <div><i class="bi bi-shield-check"></i><span>Chất lượng đảm bảo</span></div>
                <div><i class="bi bi-clock-history"></i><span>Giao trong 30 phút</span></div>
                <div><i class="bi bi-headset"></i><span>Hỗ trợ 24/7</span></div>
              </div>
            </div>
            <div class="about-visual">
              <div class="about-card"><i class="bi bi-emoji-smile"></i><strong>10,000+</strong><span>Đơn hàng thành công</span></div>
              <div class="about-card"><i class="bi bi-star-fill"></i><strong>4.8/5</strong><span>Đánh giá từ khách hàng</span></div>
              <div class="about-card"><i class="bi bi-geo-alt-fill"></i><span>Giao hàng toàn TP.HCM</span></div>
            </div>
          </div>
        </div>
      </section>
