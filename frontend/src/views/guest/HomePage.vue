...
<template>
  <div>
    ...
    <div v-if="productStore.loading" class="loading-section">
      <div class="container"><p class="loading-text">Đang tải dữ liệu...</p></div>
    </div>
    <div v-else-if="productStore.error" class="loading-section">
      <div class="container"><p class="error-text">{{ productStore.error }}</p></div>
    </div>
    <template v-else>
      ...
      <section class="section preview-section">
        <div class="container">
          ...
          <div class="grid-5">
            <ProductCard v-for="p in previewProducts" :key="p.id" :product="p" />
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="about-grid">
            <div class="about-card">
              ...
              <p>Chỉ 30 phút từ bếp nóng đến tay bạn, đảm bảo đồ ăn luôn nóng hổi.</p>
            </div>
            <div class="about-card">
              <div class="about-icon"><i class="bi bi-basket2"></i></div>
              <h3>Nguyên liệu tươi ngon</h3>
              <p>Chúng tôi chọn lọc kỹ từng nguyên liệu, cam kết chất lượng và an toàn vệ sinh.</p>
            </div>
            <div class="about-card">
              <div class="about-icon"><i class="bi bi-emoji-smile"></i></div>
              <h3>Đa dạng món ăn</h3>
              <p>200+ món ngon từ burger, pizza, gà rán đến nước uống, đáp ứng mọi khẩu vị.</p>
            </div>
            <div class="about-card">
              <div class="about-icon"><i class="bi bi-wallet2"></i></div>
              <h3>Giá cả hợp lý</h3>
              <p>Mức giá cạnh tranh cùng nhiều ưu đãi hấp dẫn cho khách hàng thân thiết.</p>
            </div>
          </div>
        </div>
      </section>
