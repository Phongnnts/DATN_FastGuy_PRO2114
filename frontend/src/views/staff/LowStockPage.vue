  ...
  <div>
    ...
    <div class="stat-grid">
      <div class="stat-card" style="border: 2px solid var(--red-active)">
        <div
          class="stat-icon"
          style="background: #f8d7da; color: var(--red-active)"
        >
          <i class="bi bi-exclamation-triangle"></i>
        </div>
        <div class="stat-value">
          {{ staffStore.lowStockIngredients.length }}
        </div>
    ...
    <div class="card card-flat">
      <div
        v-if="staffStore.lowStockIngredients.length === 0"
        class="empty-state"
        style="padding: 40px"
      >
        <i
          class="bi bi-check-circle-fill"
          style="color: #4caf50; font-size: 48px"
        ></i>
      ...
      <div v-else class="table-wrapper">
        <table class="table">
          ...
          <tbody>
            <tr
              v-for="ing in staffStore.lowStockIngredients"
              :key="ing.id"
            ...
            >
              ...
              <td>{{ ing.unit }}</td>
              <td style="color: var(--red-active); font-weight: 700">
                {{ ing.currentStock }}
              </td>
              <td>{{ ing.minStock }}</td>
              ...
              <td>
                <router-link
                  ...
                  ><i class="bi bi-plus-lg"></i> Nhập kho</router-link
                >
              </td>
            </tr>
          </tbody>
