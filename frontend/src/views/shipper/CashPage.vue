...
<template>
  <main class="cash-page">
    ...
    <template v-else>
      ...
      <template v-else>
        <section class="money-grid cod-command-summary" aria-label="Tổng quan bàn giao COD">
...
@media(min-width:900px){.cash-page{grid-template-columns:minmax(0,1.05fr) minmax(360px,.7fr);align-items:start}.cash-page>.page-header,.cash-page>.state,.cash-page>.cod-command-summary,.cash-page>.conflict-banner,.cash-page>.success{grid-column:1/-1}.history{grid-column:1/-1}.history ul{grid-template-columns:repeat(2,minmax(0,1fr))}}
</style>
