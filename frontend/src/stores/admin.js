...
export const useAdminStore = defineStore('admin', () => {
  ...
  async function getRevenueReport(params) {
    try { return await adminApi.getRevenueReport(params) } catch { return [] }
  }

  async function getTopProducts(params) {
    try { return await adminApi.getTopProducts(params) } catch { return [] }
  }

  return {
    dashboard, allUsers, allProducts, allCategories, allOrders, allZones, allShifts, allSchedules, allIngredients, loading, error,
    fetchDashboard, fetchUsers, fetchProducts, fetchCategories, fetchOrders, fetchZones, fetchIngredients, fetchShifts, fetchSchedules,
    ...
    createSchedule,
    getRevenueReport, getTopProducts
  }
})