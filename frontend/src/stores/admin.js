...
export const useAdminStore = defineStore('admin', () => {
  ...
  async function deleteVariant(id) {
   ...
   async function createModifierGroup(productId, data) {
     const res = await adminApi.createModifierGroup(productId, data);
     await fetchProducts();
     return res;
   }

   async function updateModifierGroup(groupId, data) {
     const res = await adminApi.updateModifierGroup(groupId, data);
     await fetchProducts();
     return res;
   }

   async function deleteModifierGroup(groupId) {
     const res = await adminApi.deleteModifierGroup(groupId);
     await fetchProducts();
     return res;
   }

   async function createModifierOption(groupId, data) {
     const res = await adminApi.createModifierOption(groupId, data);
     await fetchProducts();
     return res;
   }

   async function updateModifierOption(groupId, optionId, data) {
     const res = await adminApi.updateModifierOption(groupId, optionId, data);
     await fetchProducts();
     return res;
   }

   async function deleteModifierOption(groupId, optionId) {
     const res = await adminApi.deleteModifierOption(groupId, optionId);
     await fetchProducts();
     return res;
   }

   async function saveCombo(productId, data) {
     const res = await adminApi.saveCombo(productId, data);
     await fetchProducts();
     return res;
   }

   async function updateCombo(productId, data) {
     const res = await adminApi.updateCombo(productId, data);
     await fetchProducts();
     return res;
   }

   async function createComboItem(productId, data) {
     const res = await adminApi.createComboItem(productId, data);
     await fetchProducts();
     return res;
   }

   async function deleteComboItem(comboItemId) {
     const res = await adminApi.deleteComboItem(comboItemId);
     await fetchProducts();
     return res;
   }
