...
export const useStaffStore = defineStore('staff', () => {
  ...
  function mapOrder(o) {
    return {
      ...
      shipperName: o.shipperName || 'Chưa phân công',
      statusHistory: o.statusHistory || [{ status: o.orderStatus || o.status, time: o.createdAt, note: '' }],
  ...
  async function updateOrderStatus(id, status) {
    ...
    } catch { throw new Error('Không thể cập nhật trạng thái') }
  }
  ...
  return { dashboard, allOrders, allIngredients, shiftStatus, loading, lowStockIngredients, fetchDashboard, fetchOrders, fetchConfirmedOrders, fetchOrderById, updateOrderStatus, saveInternalNote, getOrderById }
})
