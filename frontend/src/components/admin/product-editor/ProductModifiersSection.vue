...
<template>
  <section class="editor-card" aria-labelledby="modifiers-title">
    <div><h2 id="modifiers-title">Topping</h2><p class="section-helper">Tổ chức lựa chọn thêm theo nhóm và giới hạn số lượng khách được chọn.</p></div>
