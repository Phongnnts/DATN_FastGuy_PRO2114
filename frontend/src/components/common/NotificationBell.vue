...
function closeAndRestoreFocus() {
  if (!notificationStore.open) return;
...
<template>
  <div v-if="show" class="notif-wrapper" ref="wrapper">
    <button ref="trigger" class="top-bar-btn" type="button" aria-label="Thông báo" aria-haspopup="true" aria-controls="notification-panel" :aria-expanded="notificationStore.open" @click="notificationStore.toggle()">
    ...
    <div v-if="notificationStore.open" id="notification-panel" class="notif-dropdown card-flat" role="region" aria-label="Danh sách thông báo" aria-live="polite">
