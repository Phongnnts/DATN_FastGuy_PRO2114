    ...
    children: [
      {
        ...
        meta: { requiresCheckedInShift: true, breadcrumb: [{ label: 'Vận hành', to: '/staff' }, { label: 'Tổng quan' }] },
      },
      {
        path: 'orders',
        name: 'StaffOrders',
        component: () => import('@/views/staff/OrdersPage.vue'),
        meta: { requiresCheckedInShift: true, breadcrumb: [{ label: 'Vận hành', to: '/staff' }, { label: 'Bếp · Đơn hàng' }] },
      },
      {
        path: 'kitchen',
      ...
      },
      {
        ...
        meta: { requiresCheckedInShift: true, breadcrumb: [{ label: 'Vận hành', to: '/staff' }, { label: 'Điều phối giao hàng' }] },
      },
      {
        path: 'orders/history',
        name: 'StaffOrderHistory',
        component: () => import('@/views/staff/OrderHistoryPage.vue'),
        meta: { breadcrumb: [{ label: 'Vận hành', to: '/staff' }, { label: 'Lịch sử đơn' }] },
      },
      {
        path: 'orders/:id',
      ...
      },
      {
        ...
        meta: { breadcrumb: [{ label: 'Vận hành', to: '/staff' }, { label: 'Ca làm' }] },
      },
    ],
  },
    ...
    children: [
      ...
      },
      {
       ...
       },
       {
        path: 'recipes',
        name: 'AdminRecipes',
        component: () => import('@/views/admin/RecipesPage.vue'),
        meta: {
          breadcrumb: [
            { label: 'Tồn kho', to: '/admin/inventory' },
            { label: 'Công thức định lượng' },
          ],
        },
       },
       {
       ...
       },
       {
         ...
         component: () => import('@/views/admin/GoodsReceiptsPage.vue'),
         meta: { breadcrumb: [{ label: 'Tồn kho', to: '/admin/inventory' }, { label: 'Phiếu nhập' }] },
       },
       {
         path: 'inventory/stock-counts',
         name: 'AdminStockCounts',
         component: () => import('@/views/admin/StockCountsPage.vue'),
         meta: { breadcrumb: [{ label: 'Tồn kho', to: '/admin/inventory' }, { label: 'Kiểm kê' }] },
       },
       {
